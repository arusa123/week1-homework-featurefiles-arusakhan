Feature: Bookcategory
  ...
  Scenario Outline: I should be able to choose any filter option with specific result
    ...
    Examples:
      ...
      | Sort by | Name: Z to A       | sorted products with products name in alphabetical order Z to A   |
  ...
  Scenario Outline: I should be able to see products display format according display
