Feature: Nopcommerce Registration
  ...
  Background:  I am on Nopcommerce Registration page
    Given  I open the Google Chrorme Browser
  ...
  Scenario: I should be able to select any one radio button from Gender Label of Your Personal Details section
    When I am on Gender label of Your personal details section
  ...
  Scenario: I should be able to register with valid mandatory (*) field date on registrtion page
